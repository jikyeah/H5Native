...
public class CommonUtilExt {
    ...
    public static String getIpCountry() {
        ...
        try {
            TelephonyManager mTelephonyManager = (TelephonyManager) AppApplication
    ...
    public static String getIpBaseStation() {
        TelephonyManager telMgr = (TelephonyManager) AppApplication
                .getInstance().getSystemService(Context.TELEPHONY_SERVICE);
        int cid = 0;
        int lac = 0;
        try {
    ...
    public static String getAndroidId() {
        ...
        return Settings.Secure.getString(AppApplication.getInstance()
    ...
    public static int getIpAddress() {
        int ipAddress = 0;
        WifiManager wifiManager = (WifiManager) AppApplication
    ...
    public static String getBpSetRetryUrl(String retryName, String sourceStr) {
        String retryUrl = replaceRealmName(retryName,
    ...
    public static String getBpPlayRetryUrl(String retryName, String sourceStr) {
        String retryUrl = replaceRealmName(retryName, "dp.ugc.pps.tv",
                sourceStr);
        return retryUrl;
    }
